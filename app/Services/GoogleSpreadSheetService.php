...
class GoogleSpreadSheetService
{
    ...
    {
        $response = $this->service->spreadsheets_values->get(env('GOOGLE_SPREADSHEET_ID'), $range);
    ...
    public function writeSheet($sheetName, $values)
    {
        ...
        try {
            ...
            $this->service->spreadsheets_values->append(env('GOOGLE_SPREADSHEET_ID'), $range, $body, $params);
