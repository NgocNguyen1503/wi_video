                ...
                <div class="col-md-3" id="left-sidebar">
                    ...
                    <div class="follow-section">
                        <h4>Số người đang follow: <span
                                class="follow-section-txt-following">{{ $user->total_following }}</span>
                        </h4>
                        <br />
                        <h4>Số người follow: <span class="follow-section-txt-follower">{{ $user->total_followers }}</span>
                        </h4>
                        <br>
                        <h4>Số lượng video: <span class="follow-section-txt-videos">{{ $user->vodeos }}</span></h4>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="file" accept=".mp4" value="" id="choose-video" class="hidden" name="video">
